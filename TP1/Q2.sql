...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('NOM : '||PILOTES(1).NOM);
    DBMS_OUTPUT.PUT_LINE('NOM : '||PILOTES(2).NOM);
    DBMS_OUTPUT.PUT_LINE('NOM : '||PILOTES(3).NOM);
    DBMS_OUTPUT.PUT_LINE('NOM : '||PILOTES(4).NOM);
    DBMS_OUTPUT.PUT_LINE('NOM : '||PILOTES(5).NOM);
